                      ...
                      onPressed: () {
                        Navigator.push(
                          ...
                          PageRouteBuilder(
                            ...
                            pageBuilder: (context, animation, secondaryAnimation) => PulsaMenu(imagen: 'assets/menu_trivial_rosa.png'),
                    ...
                    child: TriangleButton(
                      ...
                      onPressed: () {
                        Navigator.push(
                          ...
                          PageRouteBuilder(
                            transitionDuration: Duration(milliseconds: 100), // La duración de la transición
                            pageBuilder: (context, animation, secondaryAnimation) => PulsaMenu(imagen: 'assets/menu_trivial_rojo.png'),
                            transitionsBuilder: (context, animation, secondaryAnimation, child) {
                              return FadeTransition(
                                opacity: animation,
                                child: child,
                    ...
                    child: TriangleButton(
                      ...
                      onPressed: () {
                        Navigator.push(
                          ...
                          PageRouteBuilder(
                            transitionDuration: Duration(milliseconds: 100), // La duración de la transición
                            pageBuilder: (context, animation, secondaryAnimation) => PulsaMenu(imagen: 'assets/menu_trivial_azul.png'),
                            transitionsBuilder: (context, animation, secondaryAnimation, child) {
                              return FadeTransition(
                                opacity: animation,
                                child: child,
                  ...
                  CircleButton(
                    ...
                    onPressed: () {
                        Navigator.push(
                          ...
                          PageRouteBuilder(
                            transitionDuration: Duration(milliseconds: 100), // La duración de la transición
                            pageBuilder: (context, animation, secondaryAnimation) => PulsaMenu(imagen: 'assets/menu_trivial_blanco.png'),
                            transitionsBuilder: (context, animation, secondaryAnimation, child) {
                              return FadeTransition(
                                opacity: animation,
                                child: child,
                  ...
                  TriangleButton(
                    ...
                    onPressed: () {
                        Navigator.push(
                          ...
                          PageRouteBuilder(
                            transitionDuration: Duration(milliseconds: 100), // La duración de la transición
                            pageBuilder: (context, animation, secondaryAnimation) => PulsaMenu(imagen: 'assets/menu_trivial_naranja.png'),
                            transitionsBuilder: (context, animation, secondaryAnimation, child) {
                              return FadeTransition(
                                opacity: animation,
                                child: child,
                    ...
                    child: TriangleButtonAMARILLO(
                      ...
                      onPressed: () {
                        Navigator.push(
                          ...
                          PageRouteBuilder(
                            transitionDuration: Duration(milliseconds: 100), // La duración de la transición
                            pageBuilder: (context, animation, secondaryAnimation) => PulsaMenu(imagen: 'assets/menu_trivial_amarillo.png'),
                            transitionsBuilder: (context, animation, secondaryAnimation, child) {
                              return FadeTransition(
                                opacity: animation,
                                child: child,
                    ...
                    child: TriangleButtonVERDE(
                      ...
                      onPressed: () {
                        Navigator.push(
                          ...
                          PageRouteBuilder(
                            transitionDuration: Duration(milliseconds: 100), // La duración de la transición
                            pageBuilder: (context, animation, secondaryAnimation) => PulsaMenu(imagen: 'assets/menu_trivial_verde.png'),
                            transitionsBuilder: (context, animation, secondaryAnimation, child) {
                              return FadeTransition(
                                opacity: animation,
                                child: child,
